...
\begin{figure}[H]
    ...
    \caption{Aufbau der ersten Messung.}
    \label{fig:mess1}
\end{figure}
\noindent
...
Im Allgemeinen ist der Innenwiderstand des Generators zu beachten, welcher mit \mbox{$R_i=\SI{600}{\ohm}$\cite{dubbi}} angegeben ist. Wenn jedoch der Widerstand des RC-Glieds ausreichend hoch ist, kann ersterer vernachlässigt werden. Daher muss $R$ ausgemessen werden, um die Ergebnisse des Versuchs beurteilen zu können.
%
...
\begin{figure}[H]
    ...
    \caption{Aufbau der zweiten Messung.}
    \label{fig:mess2}
\end{figure}
\noindent
